        ...
        def get_auth_banner(self):
            ...
            try:
                ...
                return (
                    ...
                    f"Not working? MAKE SURE you have generated an SSH keypair: `ssh-keygen -t ed25519 -b 4096` (and follow the prompt), and you are really who you say you are!\r\n"
                ...
                return (
                    "Welcome to Poker over SSH!\r\n"
                    "Not working? MAKE SURE you have generated an SSH keypair: `ssh-keygen -t ed25519 -b 4096` (and follow the prompt), and you are really who you say you are!\r\n"
