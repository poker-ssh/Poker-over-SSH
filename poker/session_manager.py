"""
Session management module for Poker-over-SSH
Contains the core RoomSession class and session handling logic.
"""
...
class RoomSession:
    ...
    async def _register_player_for_room(self, name: str, room):
        ...
        # Import actor creation logic
        from .game_commands import create_player_actor
        player.actor = await create_player_actor(self, player, room)
        return player
